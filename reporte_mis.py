...
# 1. CONEXIÓN AL REPOSITORIO (RUTA RELATIVA CORREGIDA CON 'TPS')
...
plt.tight_layout()
plt.savefig('kpi1_porcentaje_tipo.png') # Se guarda directo en Dashboard-KPIs
plt.close()
...
plt.tight_layout()
plt.savefig('kpi2_riesgo_vehicular.png') 
plt.close()
...
plt.tight_layout()
plt.savefig('kpi3_aprobacion_tipo.png') 
plt.close()

print("\n[PROCESO TERMINADO] Los 3 gráficos han sido generados y guardados con éxito en tu repositorio MIS.")